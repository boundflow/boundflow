...
type JobRepository interface {
	...
	// SweepAbandonedJobs finishes flagged jobs no worker holds — parked, delayed, or
	// simply unclaimed. Returns the workflow ids finished.
	SweepAbandonedJobs(ctx context.Context, partitionID string) ([]string, error)
