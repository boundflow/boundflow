...
type Workflow struct {
	...
	// request_id of the run that failed the workflow; empty until a run fails.
	LastFailedRequestId string `protobuf:"bytes,11,opt,name=last_failed_request_id,json=lastFailedRequestId,proto3" json:"last_failed_request_id,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Workflow) GetLastFailedRequestId() string {
	if x != nil {
		return x.LastFailedRequestId
	}
	return ""
}
...
const file_boundflow_v1_workflow_proto_rawDesc = "" +
	...
	"\vtriggerable\x18\x04 \x01(\bR\vtriggerable\"\x80\x03\n" +
	"\bWorkflow\x12\x0e\n" +
	...
	" \x01(\x0e2\x1b.boundflow.v1.WorkflowStateR\rworkflowState\x123\n" +
	"\x16last_failed_request_id\x18\v \x01(\tR\x13lastFailedRequestId*\x9f\x01\n" +
