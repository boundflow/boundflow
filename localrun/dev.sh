...
echo ""
echo -e "${CYAN}Create workflow (replace <tenant-id>):${NC}"
echo "  grpcurl -plaintext -d '{\"workflow_type\":\"database\",\"tenant_id\":\"<tenant-id>\",\"initial_state\":{\"sku\":\"standard\"},\"operation_timeout_seconds\":30}' localhost:$SERVER_PORT boundflow.v1.WorkflowService/CreateWorkflow"
echo ""
