...
echo ""
echo "Step 3 — Create a workflow (use id from above as tenant_id):"
echo "  grpcurl -plaintext -d '{\"workflow_type\":\"database\",\"tenant_id\":\"<tenant-id>\",\"initial_state\":{\"sku\":\"standard\"}}' localhost:50051 boundflow.v1.WorkflowService/CreateWorkflow"
echo ""
echo "Step 4 — Check workflow state (use workflow_id from above):"
echo "  grpcurl -plaintext -d '{\"workflow_id\":\"<workflow-id>\"}' localhost:50051 boundflow.v1.WorkflowService/GetWorkflow"
echo ""
wait
